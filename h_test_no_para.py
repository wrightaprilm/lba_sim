...
h1 = 'Helotrophi', 'Enithares', 'Nerthra sp', 'Ochterus m', 'Ilyocoris', 'Aphelochei','Laccotreph', 'Diplonychu'

#H2: helo in outgroup, but paraplea in in-group
h2 = 'Enithares', 'Nerthra sp', 'Ochterus m', 'Ilyocoris', 'Aphelochei','Laccotreph', 'Diplonychu'
